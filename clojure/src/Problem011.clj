...
(ns problems
  (:use [common :only (product-of-digits-of)]))
...
(defn product-right [g, x, y]
  (if (< x 18)
    (product-of-digits-of [(nth (nth g (- y 1)) (- x 1))
                           (nth (nth g (- y 1)) x 1)
                           (nth (nth g (- y 1)) (+ x 1))
                           (nth (nth g (- y 1)) (+ x 2))])
    nil))

(defn product-down [g, x, y]
  (if (< y 18)
    (product-of-digits-of [(nth (nth g (- y 1)) (- x 1))
                           (nth (nth g y) (- x 1))
                           (nth (nth g (+ y 1)) (- x 1))
...
(defn product-down-diag-right [g, x, y]
  (if (and (< x 18) (< y 18))
    (product-of-digits-of [(nth (nth g (- y 1)) (- x 1))
                           (nth (nth g y) x)
                           (nth (nth g (+ y 1)) (+ x 1))
...
(defn product-down-diag-left [g, x, y]
  (if (and (> x 3) (< y 18))
    (product-of-digits-of [(nth (nth g (- y 1)) (- x 1))
                           (nth (nth g y) (- x 2))
                           (nth (nth g (+ y 1)) (- x 3))
...
(defn find-largest-prod-of-four [g]
